Instructions to get sales info from amazon website and run application:
...
Keep amazonster.csv in the same folder as the executables (it is the master spreadsheet that will be added to again and again)
